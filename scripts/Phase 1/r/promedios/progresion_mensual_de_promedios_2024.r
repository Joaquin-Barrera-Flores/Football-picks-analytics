...
ggsave(
    filename = "outputs/plots/Phase 1/r/promedios/r_progresion_mensual_de_promedios_2024.png",
    plot = A,
    width = 12,
    height = 8,
    units = "in",
...
write.csv(prom_mensual, here("data","Phase 1", "processed", "r", "metricas_comparativas", "promedios", "promedios_mensuales_2024.csv"))
