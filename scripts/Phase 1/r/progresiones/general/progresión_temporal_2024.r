...
# 11. Guardar gráfica
ggsave(
  filename = "outputs/plots/Phase 1/r/progresiones/general/r_progresión_anual_2024.png",
  plot = C,
  width = 20,
  height = 12,
  units = "in",
...
walk(jugadores, ~ write.csv(
  ultimos[[.x]],
  here("data", "Phase 1", "processed", "r", "metricas_individuales", "maximos", paste0("puntaje_maximo_", .x, "_2024.csv")),
  row.names = FALSE
))