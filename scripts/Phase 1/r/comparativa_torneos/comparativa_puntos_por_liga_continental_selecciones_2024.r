...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/r_comparativa_puntos_por_continental_selecciones_2024.png",
    plot = con_s,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_continentales_selecciones_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo",  "restantes", "puntuaciones_por_ligas_continentales_selecciones_2024.csv"))
write.csv(suma_puntos_por_torneo_continental_selecciones, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo", "principales", "puntuaciones_por_ligas_continentales_selecciones_principales_2024.csv"))