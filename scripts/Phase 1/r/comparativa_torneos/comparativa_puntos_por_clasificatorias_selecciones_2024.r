...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/comparativa_puntos_por_clasificatorias_selecciones_2024.png",
    plot = cs,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_clasificatorias_selecciones_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo", "restantes", "puntuaciones_por_clasificatorias_selecciones_2024.csv"))