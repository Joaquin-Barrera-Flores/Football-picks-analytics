...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/r_comparativa_puntos_por_mundial_clubes_2024.png",
    plot = mc,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_mundial_clubes_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo",  "restantes", "puntuaciones_por_mundial_clubes_2024.csv"))