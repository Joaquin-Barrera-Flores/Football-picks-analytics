...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/r_comparativa_puntos_por_liga_2024.png",
    plot = B,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_ligas_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo",  "restantes", "puntuaciones_por_liga_2024.csv"))
write.csv(suma_puntos_por_torneo, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo", "principales", "puntuaciones_por_ligas_principales_2024.csv"))