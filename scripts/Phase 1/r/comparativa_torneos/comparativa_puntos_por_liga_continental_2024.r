...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/r_comparativa_puntos_por_continental_2024.png",
    plot = con,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_continentales_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo",  "restantes", "puntuaciones_por__liga_continental_2024.csv"))
write.csv(suma_puntos_por_torneo_continental, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo", "principales", "puntuaciones_por_ligas_continentales_principales_2024.csv"))