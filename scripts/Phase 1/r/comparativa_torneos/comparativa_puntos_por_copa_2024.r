...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/Phase 1/r/comparativa_torneos/r_comparativa_puntos_por_copa_2024.png",
    plot = copa,
    width = 18,
    height = 10,
    units = "in",
...
write.csv(filtro_copas_total, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo",  "restantes", "puntuaciones_por_copa_2024.csv"))
write.csv(suma_puntos_por_copa, here("data", "Phase 1", "processed", "r", "metricas_comparativas", "puntuaciones_por_torneo", "principales", "puntuaciones_por_copas_principales_2024.csv"))