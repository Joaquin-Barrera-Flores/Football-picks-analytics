...
# Guardar gráfico
ggsave(
    filename = "outputs/plots/r/puntuaciones/comparativas/por_torneo/2024/r_comparativa_puntos_por_supercopas_2024.png",
    plot = sup,
    width = 12,
    height = 10,
    units = "in",
...
write.csv(filtro_supercopas_total, here("data", "processed", "r", "metricas_comparativas", "puntuaciones", "por_torneo", "totales", "2024", "puntuaciones_por__supercopas_2024.csv"))
write.csv(suma_puntos_por_supercopas, here("data", "processed", "r", "metricas_comparativas", "puntuaciones", "por_torneo", "principales", "2024", "puntuaciones_por_supercopas_principales.csv"))