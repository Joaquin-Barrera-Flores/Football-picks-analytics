...
write.csv(filtro_ligas_total, here("data", "processed", "r", "metricas_comparativas", "puntuaciones_por_liga_2024.csv"))
write.csv(suma_puntos_por_torneo, here("data", "processed", "r", "metricas_comparativas", "puntuaciones_por_ligas_principales.csv"))