...
- **Live Dashboard:** **[Interactive Tableau Dashboard](https://public.tableau.com/app/profile/fernando.joaquin.barrera.flores/vizzes)**
- **Dataset:** **[Kaggle Dataset](https://www.kaggle.com/datasets/fjoaquinbarreraf/football-picks-analytics-dataset)**
...
| :--------------------------- | :------------------------------------------------------------------------------------------------------ | :---------------- |
| **Data Collection** | Weekly data gathered via structured polls.                                                              | `WhatsApp`        |
| **Data Storage & Structure** | Designed a relational database to store raw and processed data.                                         | `SQL`             |
| **ETL & Data Modeling** | Cleaned data, handled missing values, and engineered new features (e.g., accuracy scores, "upset" metrics). | `R (Tidyverse)`   |
| **Analysis & Visualization** | Performed exploratory data analysis and built a multi-page interactive dashboard.                       | `Tableau`, `ggplot2` |
| **Documentation & Version Control**| Maintained code and project documentation.                                                          | `GitHub`          |
